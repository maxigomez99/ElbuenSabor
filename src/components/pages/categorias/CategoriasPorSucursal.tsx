  ...
  return (
    <div>
      ...
      {selectedEmpresa && selectedSucursal ? (
        <ArbolCategoriaPorSucursal key={refreshKey} selectedEmpresa={selectedEmpresa} selectedSucursal={selectedSucursal} />
      ) : (
        <p>Por favor, seleccione una empresa y una sucursal para ver las categorías.</p>
      )}
    </div>
  );
}
